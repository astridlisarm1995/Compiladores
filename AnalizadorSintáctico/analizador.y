...
declaracion:	T_TDATO id T_PTCOM		{strcat($1," ");strcat($1,$2);$$=$1;}|
	...
	/*Excepciones declaraciones*/
		T_TDATO id {printf (" Error en linea %d: Te faltó poner el ;  en la declaración. \n", lineas-1);};
...
operaciones:	asignaciones T_PTCOM	{}|
	...
	/*Excepciones operaciones*/
		operArit	{printf(" Error en linea %d: Te faltó poner el ; en la operación aritmética.\n\n",lineas-1);};
...
asignaciones:	T_ID T_OPASIG T_ID	{strcat($1,$2);strcat($1,$3);$$=$1;}|
	...
	/*Excepciones asignaciones*/
		T_OPASIG T_INT {printf(" Error en linea %d: Te faltó poner la Variable.\n", lineas+1);};
...
if:		T_IF T_PA valores T_OPRELACION valores T_PC T_CA contsEstructura T_CC	{
	...
	/*Excepciones if*/
		T_IF T_PA valores T_OPRELACION valores T_PC T_CA contsEstructura {printf(" Error en linea %d: Te faltó cerrar la llave en el if. \n", lineas-1);};
